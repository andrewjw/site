...
with a discussion about what does healthy mean, and how do you know what consitutes your estate?
...
Code health is about your code at rest, so is not about DORA metrics or your KPIs. You can run static checks to determine the
...
Lastly he talked about how to communicate the code health, and demonstrated a dashboard, and how they use that to communicate
with teams and stakeholders, and influence future plans.

## Code Your Future

_[Germán Bencci](https://twitter.com/gbencci)_ ([Video](https://leaddev.com/communication/hear-from-our-charity-partner-code-your-future))
...
slides on their own. Luckily, Plum is a LeadDev regular, and it shows. In this talk she gets you through the decision
